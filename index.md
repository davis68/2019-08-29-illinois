...
venue: "National Center for Supercomputing Applications"        # brief name of host site without address (e.g., "Euphoric State University")
address: "1205 W. Clark str, Urbana, IL, 61801"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "US"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "40.114832,-88.225004"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Samniqueka ('Sam') Halsey", "Dena Strong", "Maxim Belkin"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Dave Mussulman", "Halie Rando"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: "https://pad.carpentries.org/2019-05-21-ncsa"            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
